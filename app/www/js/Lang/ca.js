...
Lang['ca'] = {
	...
	userRegistered: "L'usuari ha estat registrat. Comprova el teu correu per activar el teu compte",
	locationIAS: "Ubicació actual",
	enableGPS: "Si us plau, activa el teu GPS per localitzar IAS",
	...
	aboutText: "<div class=WordSection1>" +
				...
				"	style='font-family:\"Calibri\",\"sans-serif\";mso-bidi-font-family:Arial;" +
				"	mso-ansi-language:EN-GB'> té l'objectiu comú de contribuir a reduir els impactes de les IAS en la biodiversitat i en la salut i, també, en termes econòmics que tenen els IAS en el nostre entorn.<o:p></o:p></span></p>" +
				"	<p class=MsoNormal><span lang=EN-GB style='mso-ansi-language:EN-GB'><o:p>&nbsp;</o:p></span></p>" +
				...
				"	<p class=MsoNormal style='text-align:justify'><span lang=EN-GB" +
				"	style='font-family:\"Calibri\",\"sans-serif\";mso-bidi-font-family:Arial;" +
				"	mso-ansi-language:EN-GB'>Agraïments a la  Unió Europea i a la col·laboració de l’Institut Cartogràfic i Geològic de Catalunya.<o:p></o:p></span></p>" +
				"	<p class=MsoNormal style='text-align:justify'><span lang=EN-GB" +
				...
				"</div>",
	locateIAS: "Localitza",
	sendingPendingObs: "Enviant observacions pendents",
	addNote: "Afegir una nota",
	one 		: "Una",
	few			: "Poques",
	several		: "Algunes",
	noGPS		: "No GPS",
